...
>> **use_lasso** : "yes" or "no", which means whether you use lasso in the **Rule I**.
...
- **./include/safari.h** :  
    ...
    - **./src/safair/phase_one.cpp** :  
        The implementation of the **Rule I***(without lasso). 
    - **./src/safair/phase_one_with_lasso.cpp** :  
        The implementation of the **Rule I**(with lasso). 
